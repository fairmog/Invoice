...
<body>
    <div class="email-container">
        ...
        <div class="footer">
            ...
            ${businessSettings?.premiumActive && businessSettings.hideAspreeBranding ? '' : `
            <div class="footer-brand">
                <p>${businessSettings?.premiumActive && businessSettings.customHeaderText ? 
                    businessSettings.customHeaderText : 
                    'Powered by Aspree Invoice Generator'}</p>
            </div>
            `}
        </div>
    </div>
